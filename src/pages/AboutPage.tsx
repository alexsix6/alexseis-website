  ...
  useEffect(() => {
    ...
    schemaScript.innerHTML = JSON.stringify({
      ...
      "description": localizedSchema(
        "Creador de INNATE.data — arquitectura zero-egress de IA empresarial. Sistema NEURA: 282M+ registros, 270% ROI verificado.",
        "Creator of INNATE.data — zero-egress enterprise AI architecture. NEURA System: 282M+ records, 270% verified ROI."
      ),
      "expertise": ["Zero-Egress AI", "Enterprise Data Architecture", "MCP Servers", "BigQuery", "Vertex AI", "Cloud Run"],
      "knowsAbout": ["INNATE.data", "Zero-Egress Architecture", "MCP Servers", "BigQuery", "Claude AI", "NEURA System", "Vertex AI"],
      "hasOccupation": {
        "@type": "Occupation",
